...
class SubCategoryDao {
  ...
  static String get tableData {
    return "INSERT INTO $_tableName ($_name, $_imagePath, $_categoryId) VALUES "
        "('${subCategoryNames[0]}', '${AppImages.logoMini}', ${categoryIDs[0]}), "
        "('${subCategoryNames[1]}', '${AppImages.logoMini}', ${categoryIDs[1]}), "
        "('${subCategoryNames[2]}', '${AppImages.logoMini}', ${categoryIDs[2]}), "
        "('${subCategoryNames[3]}', '${AppImages.logoMini}', ${categoryIDs[3]}), "
        "('${subCategoryNames[4]}', '${AppImages.logoMini}', ${categoryIDs[4]}), "
        "('${subCategoryNames[5]}', '${AppImages.logoMini}', ${categoryIDs[5]}), "
        "('${subCategoryNames[6]}', '${AppImages.logoMini}', ${categoryIDs[6]}), "
        "('${subCategoryNames[7]}', '${AppImages.logoMini}', ${categoryIDs[7]}), "
        "('${subCategoryNames[8]}', '${AppImages.logoMini}', ${categoryIDs[8]}), "
        "('${subCategoryNames[9]}', '${AppImages.logoMini}', ${categoryIDs[9]}), "
        "('${subCategoryNames[10]}', '${AppImages.logoMini}', ${categoryIDs[10]}), "
        "('${subCategoryNames[11]}', '${AppImages.logoMini}', ${categoryIDs[11]}), "
        "('${subCategoryNames[12]}', '${AppImages.logoMini}', ${categoryIDs[12]}), "
        "('${subCategoryNames[13]}', '${AppImages.logoMini}', ${categoryIDs[13]}); ";
  }

  Future<List<SubCategory>> findAll(Database db) async {
