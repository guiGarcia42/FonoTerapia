      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            Expanded(
              child: Padding(
                padding: EdgeInsets.symmetric(horizontal: responsiveSize.scaleSize(60), vertical: responsiveSize.height * 0.1,),
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          // Adicione a lógica para a assinatura premium aqui
                        },
                        ...
                        child: Text(
                          ...
                          style: TextStyles.buttonTextDialog.copyWith(
                            fontSize: responsiveSize
                                .scaleSize(TextStyles.buttonTextDialog.fontSize!),
                          ),
                        ),
                      ),
                    ),
