...
class _BuildGameListOfOptionsState extends State<BuildGameListOfOptions> {
  ...
  Widget _buildGridComponent(List<GameComponent> gameComponents, bool isImage) {
    return widget.responsiveSize.isTablet()
        ? TabletGridViewComponent(
            gameComponents: gameComponents,
            onTap: widget.onTap,
            isImage: isImage,
            responsiveSize: widget.responsiveSize,
          )
    ...
    if ([2, 8].contains(widget.subCategoryId)) {
      ...
      return Padding(
        padding: EdgeInsets.symmetric(
          vertical: widget.responsiveSize.scaleSize(50),
        ),
        child: Row(
  ...
  Padding _buildTextInputComponent() {
    ...
    return Padding(
      padding: EdgeInsets.symmetric(
        vertical: widget.responsiveSize.scaleSize(50),
        horizontal: widget.responsiveSize.scaleSize(100),
      ),
      child: TextField(
        ...
        style: TextStyles.textField.copyWith(
          fontSize: widget.responsiveSize.scaleSize(TextStyles.textField.fontSize!),
        ),
